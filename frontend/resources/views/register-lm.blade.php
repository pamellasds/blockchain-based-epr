...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cadastrar Laboratório Médico') }}</div>

                <div class="card-body">
                    <form method="POST" action="send-register-lm">
                        @csrf

                        <p><strong>Dados do Laboratório Médico</strong></9>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="numero" type="text" class="form-control @error('numero') is-invalid @enderror" name="name" value="{{ old('numero') }}" required autocomplete="numero" autofocus>
                                @error('numero')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
