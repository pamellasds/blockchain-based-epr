...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cadastrar Profissional da Saúde') }}</div>

                <div class="card-body">
                    <form method="POST" action="send-register-ps">
                        @csrf
                        ...
                        <p><strong>Dados Profissionais</strong></9>

                        <div class="form-group row">
                            <div class="col-md-4">
                                <label for="profissao" class="col-form-label text-left">{{ __('Profissão') }}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label for="especialidade" class="col-form-label text-left">{{ __('Especialidade') }}</label>
                                <input id="especialidade" type="text" class="form-control @error('especialidade') is-invalid @enderror" name="especialidade" value="{{ old('especialidade') }}" required autocomplete="especialidade" autofocus>
                                @error('cep')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
