    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 6%;">
            <div class="col">
                ...
                <form method="post" action="get-se-data">
                    @csrf
                    <fieldset>
                        <legend>
                            <p>Speciality Record</p>
                        </legend>
            ...
            @endif
                ...
                @if (!empty($obj) && isset($obj->NomeAluno))
                    <form method="post" action="send-se-register">
                        @csrf
                        <fieldset>
                            <table cellspacing="10">
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <label for="courseName">Specialty Name: </label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input id="specialityId" type="text" name="specialityId">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
            ...
            <div class="col">
                @if (!empty($obj) && isset($obj->NomeAluno))
                    <section class="tracking" style="height: 120%; margin-left: 10%">
