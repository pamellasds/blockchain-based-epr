...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 6%;">
            <div class="col">
                <form method="post" action="get-rcm-data">
                    @csrf
                    <fieldset>
                        <legend>
                            <p>Medical Record</p>
                ...
                @if (!empty($obj) && isset($obj->NomeAluno))
                    <form method="post" action="send-rcm-register">
                        @csrf
                        <fieldset>
                            <table cellspacing="10">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input id="universityId" readonly type="text" name="universityId"
                                            value="{{ $obj->CodDiploma }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
